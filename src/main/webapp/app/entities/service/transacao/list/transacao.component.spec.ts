...
describe('Transacao Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'transacao', component: TransacaoComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.transacaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to transacaoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTransacaoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTransacaoIdentifier).toHaveBeenCalledWith(entity);
