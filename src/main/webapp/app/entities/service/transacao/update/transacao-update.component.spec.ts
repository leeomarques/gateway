...
describe('Transacao Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Orcamento query and add missing value', () => {
      ...
      const orcamento: IOrcamento = { id: 388 };
      transacao.orcamento = orcamento;

      const orcamentoCollection: IOrcamento[] = [{ id: 24515 }];
    ...
    it('Should call Categoria query and add missing value', () => {
      const transacao: ITransacao = { id: 456 };
      const categoria: ICategoria = { id: 26134 };
      transacao.categoria = categoria;

      const categoriaCollection: ICategoria[] = [{ id: 17137 }];
    ...
    it('Should update editForm', () => {
      const transacao: ITransacao = { id: 456 };
      const orcamento: IOrcamento = { id: 10272 };
      transacao.orcamento = orcamento;
      const categoria: ICategoria = { id: 6370 };
      transacao.categoria = categoria;
